...
const ProductCard = ({item, getProducts}) => {
  const {name,image,price, discountRate,amount,id} =item
          ...
          <div className="card-body">
            ...
            <div className="product-price">
              <p className="text-warning h2">
                $<span className="damping-price">{(price * discountRate)}</span>
            ...
            <div className="mt-2">
              Product Total: $<span className="product-line-price">{(price * discountRate * amount).toFixed(2)}</span>
            </div>
          </div>
        </div>
      </div>
