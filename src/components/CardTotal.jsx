...
const subTotal = products.reduce((acc, product) => product.price * product.amount * product.discountRate + acc,0)
  return (
    <table className="table w-100">
      <tbody>
        ...
        <tr className="text-end">
          ...
          <td>
            $
            <span className="total">{(subTotal + shipping + (taxRate * subTotal) )}
            </span>
          </td>
        </tr>
      </tbody>
